# Defines help function for stocks_app
...
def help():
    ...
    print('For more help, see the documentation and examples at https://github.com/jlhitt1993/stocks_app/blob/master/README.md')